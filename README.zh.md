...
Jigsaw是一套完整强大的Web组件集，当前的版本里包含了42个组件、6个容器、5个服务、5个指令，基本上覆盖了Web应用的方方面面。简单的说，其他组件集有的，Jigsaw都有，而且功能更强大性能更好。因此完全没有必要担心Jigsaw的功能缺失的问题。
...
32 | Tag | 一个标签控件。 | [Demo](https://jigsaw-zte.gitee.io/latest/#/components/tag/demo/basic)
33 | Textarea | 用于收集多行文本的表单控件。 | [Demo](https://jigsaw-zte.gitee.io/latest/#/components/textarea/demo/basic)
34 | Tile | 通过平铺方式显示数据列表。 | [Demo](https://jigsaw-zte.gitee.io/latest/#/components/tile/demo/full)
35 | TileLite | 通过平铺方式显示数据列表。 | [Demo](https://jigsaw-zte.gitee.io/latest/#/components/tile-lite/demo)
36 | Time | 一个时间选择器，用于选择时分秒。 | [Demo](https://jigsaw-zte.gitee.io/latest/#/components/time-picker/demo/basic)
37 | Time Section | 一个时间规则选择器，可设置用于匹配时间的规则。 | [Demo](https://jigsaw-zte.gitee.io/latest/#/components/time-section/demo/basic)
38 | Tooltip | 一个自定义的 tooltip。 | [Demo](https://jigsaw-zte.gitee.io/latest/#/components/tooltip/demo/inline)
39 | Transfer | 一个复杂选择器，用于大量条目的选择，支持分页。 | [Demo](https://jigsaw-zte.gitee.io/latest/#/components/transfer/demo/basic)
40 | Tree | 以树的方式渲染一些具有从属关系的数据，基于 [ztree](http://www.treejs.cn/v3/main.php#_zTreeInfo)。 | [Demo](https://jigsaw-zte.gitee.io/latest/#/components/tree/demo/editable)
41 | Upload | 打开文件选择器挑选一些文件并上传到服务器。 | [Demo](https://jigsaw-zte.gitee.io/latest/#/components/upload/demo/basic)
42 | Viewport | 表示一个抽象视图的一部分。 | [Demo](https://jigsaw-zte.gitee.io/latest/#/components/table/demo/big-table)
