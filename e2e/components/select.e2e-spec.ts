...
describe('select', () => {
    ...
    describe('text basic functions', () => {
        ...
        it('should select the clicked option when click the option', () => {
            ...
            //选择第二项
            optionEl1.click();
            expect(selectEl.element(by.css('.jigsaw-select')).getText())
                .toBe(optionEl1.element(by.css('.jigsaw-option')).getText());
            ...
            optionEl2.click();
            expect(selectEl.element(by.css('.jigsaw-select')).getText())
                .toBe(optionEl2.element(by.css('.jigsaw-option')).getText());
