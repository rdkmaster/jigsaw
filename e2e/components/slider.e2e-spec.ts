...
describe('slider', () => {
    ...
    describe('test basic ', () => {
        ...
        it('shoud drag and drop slider', () => {
            ...
            browser.actions().dragAndDrop(sliderHandle.get(0), {x: 20000, y: 0}).perform();
            expect(handleTag.get(0).getAttribute('ng-reflect-value')).toBe('10');
            browser.actions().dragAndDrop(sliderHandle.get(1), {x: -20000, y: 0}).perform();
            ...
            browser.actions().dragAndDrop(sliderHandle.get(3), {x: -20000, y: 0}).perform();browser.sleep(1000);
            expect(handleTag.get(3).getAttribute('ng-reflect-value')).toBe('0');
            browser.actions().dragAndDrop(sliderHandle.get(5), {x: 20000, y: 0}).perform();browser.sleep(1000);
            expect(handleTag.get(5).getAttribute('ng-reflect-value')).toBe('100');
            browser.actions().dragAndDrop(sliderHandle.get(7), {x: 0, y: 10000}).perform();
            expect(handleTag.get(7).getAttribute('ng-reflect-value')).toBe('0');
            browser.actions().dragAndDrop(sliderHandle.get(8), {x: 0, y: -10000}).perform();
            expect(handleTag.get(8).getAttribute('ng-reflect-value')).toBe('100');
            browser.actions().dragAndDrop(sliderHandle.get(9), {x: 0, y: 10000}).perform();
