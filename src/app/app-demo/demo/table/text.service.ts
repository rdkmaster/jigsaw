...
export class TableTextService {
    public text: object = {
        ...
        checkboxColumnObjectCell: `
            ## checkboxColumnObjectCell不知道名字

            这demo介绍table中使用内置checkbox渲染器
        `,
        checkboxColumnPageable: `
            ## checkboxColumnPageable不知道名字
        ...
        indexColumnWithPaging: `
            ## indexColumnWithPaging不知道名字
        `,
        withPopup: `
            ## withPopup 不知道名字
        `,
        templateRefRenderer: `
            ## templateRefRenderer不知道名字
        `
    }
}
