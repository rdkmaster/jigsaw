...
export class JigsawDemoDescription implements OnInit, AfterContentInit {
    ...
    createProjectData(): any {
        ...
        const moduleClassName = findModuleClassName(project.files['src/app/app-develop/demo.module.ts']);
        ...
        project.files['src/app/app.component.css'] = require('!!raw-loader!../../../../src/app/app-develop/live-demo-wrapper.css').default;
