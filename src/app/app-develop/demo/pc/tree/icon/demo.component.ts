...
export class ZTreeIconDemoComponent implements AfterViewInit {
    ...
    public iconSuit3: ZTreeIconSuit = {
        edit: "e166",
        remove: "e17b",
        open: "/app/app-develop/demo/pc/tree/icon/assets/web.svg",
        close: "/app/app-develop/demo/pc/tree/icon/assets/web.svg",
        document: "e9dc",
        checkboxChecked: "/app/app-develop/demo/pc/tree/icon/assets/checkbox-checked.svg",
        checkboxNotCheck: "/app/app-develop/demo/pc/tree/icon/assets/checkbox-square.svg",
        checkboxHalf: "/app/app-develop/demo/pc/tree/icon/assets/checkbox-minus.svg",
        nodeOpen: "ea24",
        nodeClose: "ea57"
    };
