...
class MockData {
    ...
    static initDataSet() {
        ...
        this.dataSet['fish-bone-data1'] = this.getFishBoneData(0, 4);
        this.dataSet['fish-bone-data2'] = this.getFishBoneData(5, 11);
    }
    ...
    static getFishBoneData(startIndex, endIndex){
        const fishBoneData = [
            {
                "id": 0,
                "name": "联合附着",
        ...
        return fishBoneData.slice(startIndex, endIndex + 1);
    }
}
