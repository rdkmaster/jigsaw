...
import {StackAreaGraphData} from "jigsaw/core/data/graph-data";
...
export class StackAreaGraphComponent {
    constructor(public http: HttpClient) {
        this.stackAreaData = new StackAreaGraphData();
        ...
        this.stackAreaFromAjax = new StackAreaGraphData();
        this.stackAreaFromAjax.http = http;
        this.stackAreaFromAjax.fromAjax('/stack-area-data');
    }

    stackAreaData: StackAreaGraphData;
    stackAreaFromAjax: StackAreaGraphData;
