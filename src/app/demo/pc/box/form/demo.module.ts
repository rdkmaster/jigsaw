...
import {
    ...
    JigsawTimeModule, JigsawTileSelectModule, JigsawRangeTimeModule,
    JigsawCheckBoxModule, JigsawSliderModule, JigsawSwitchModule,
    JigsawBoxModule, JigsawDateTimePickerModule, JigsawRangeDateTimePickerModule
