...
export const routerConfig = [
    {
        path: "basic",
        component: StepsHorizontalBasicComponent
    },
    {
        path: "vertical",
        component: StepsVerticalFullComponent
    },
    {
        path: "step-interactive",
        component: StepsClickChangeStatusComponent
    },
    {
        path: "custom-icons",
        component: StepsCustomIconsComponent
    },
    {
        path: "steps-multiline",
        component: StepsMultilineComponent
    }
];
...
export class StepsFallbackDemoModule {}
