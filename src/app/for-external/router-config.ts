...
export const routerConfigPC = [
    ...
    { path: "demo/menu", component: MenuAllComponent, group: componentGroup.directive },
    ...
    { path: "demo/upload", component: UploadAllComponent, group: componentGroup.directive },
    { path: "demo/adjust-font-color", component: AdjustFontColorAllDemoComponent, group: componentGroup.service },
    { path: "demo/theme-properties", component: ThemePropertiesAllComponent, group: componentGroup.service },
    ...
    { path: "demo/loading", component: LoadingDemoComponent, group: componentGroup.service },
    ...
    { path: "demo/tooltip", component: TooltipDemoComponent, group: componentGroup.directive },
    { path: "demo/tag", component: TagDemoComponent, group: componentGroup.general },
    { path: "demo/progress", component: ProgressDemoComponent, group: componentGroup.display },
    ...
    { path: "demo/popup", component: PopupDemoComponent, group: componentGroup.service },
    { path: "demo/data-encapsulation", component: DataEncapsulationDemoComponent, group: componentGroup.service },
