...
export class JigsawAutoDisplayBasicDemoComponent implements OnInit {
    ...
    public addModeledPieGraph() {
        const data: any = {
            ...
            initData: {
                ...
                indicatorsField: ["sales"]
            },
        }
        const modeledData = this._getModeledPieGraph(data);
        this.data.push(data);
        this.autoDisplay.update();
    }
    ...
    private _getTemplateData(data) {
        // data.templateOption = JSON.stringify(this.template[3].option);
        // data.initData.templateOption = JSON.stringify(this.derivedTemplate[1].option);
        // series: [{
        //     "dimensions": [
        //         {
        //             "name": "Sagitar"
        ...
        // legendSource: "dim"
        data.series =
            data.initData.templateOption = eval("(" + this.derivedTemplate[0].option + ")");
        console.log(data);
    }
