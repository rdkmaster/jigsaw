...
import {RangeDateTimeSelectShowBorderComponent} from "./demo.component";

import {JigsawHeaderModule} from "jigsaw/public_api";

@NgModule({
    declarations: [RangeDateTimeSelectShowBorderComponent],
    exports: [RangeDateTimeSelectShowBorderComponent],
...
export class RangeDateTimeSelectShowBorderModule {
