...
import { TabBarStyleOptionsDemoComponent } from '../tab-bar/style-options/demo.component';
import { TabBarStyleOptionsDemoModule } from '../tab-bar/style-options/demo.module';
