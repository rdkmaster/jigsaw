...
export class ZTreeIconDemoComponent implements AfterViewInit {
    ...
    public iconSuit3: ZTreeIconSuit = {
        edit: "e166",
        remove: "e17b",
        open: "/app/for-internal/demo/pc/tree/icon/assets/web.svg",
        close: "/app/for-internal/demo/pc/tree/icon/assets/web.svg",
        document: "e9dc",
        checkboxChecked: "/app/for-internal/demo/pc/tree/icon/assets/checkbox-checked.svg",
        checkboxNotCheck: "/app/for-internal/demo/pc/tree/icon/assets/checkbox-square.svg",
        checkboxHalf: "/app/for-internal/demo/pc/tree/icon/assets/checkbox-minus.svg",
        nodeOpen: "ea24",
        nodeClose: "ea57"
    };
    ...
    constructor() {
        ...
        this.xml2.fromXML(`
            <node>
                <node label="Web代码" open="true" iconUnicode="/app/app-develop/demo/pc/tree/icon/assets/pc.svg">
                    <node label="页面1" open="false" iconUnicode="/app/app-develop/demo/pc/tree/icon/assets/web.svg">
                        <node label="src" open="true">
                            <node label="index.html" iconUnicode="e5a2"></node>
                            <node label="styles.css" iconUnicode="e5a1"></node>
                            <node label="component1.ts" iconUnicode="e5a0"></node>
                    ...
                    <node label="页面2" open="true" iconUnicode="/app/app-develop/demo/pc/tree/icon/assets/web.svg">
                        <node label="src" open="true">
                            <node label="index.html" iconUnicode="e5a2"></node>
                            <node label="styles1.css" iconUnicode="e5a1"></node>
                            <node label="styles2.css" iconUnicode="e5a1"></node>
                ...
                <node label="服务端" open="true" iconUnicode="e3a0">
                    <node label="src" open="true">
                        <node label="查询服务1.sql" iconUnicode="/app/app-develop/demo/pc/tree/icon/assets/file.svg"></node>
                        <node label="查询服务2.sql" iconUnicode="/app/app-develop/demo/pc/tree/icon/assets/file.svg"></node>
                        <node label="查询服务3.sql" iconUnicode="/app/app-develop/demo/pc/tree/icon/assets/file.svg"></node>
                        <node label="查询服务4.sql" iconUnicode="/app/app-develop/demo/pc/tree/icon/assets/file.svg"></node>
                    </node>
                </node>
            </node>
        `);
