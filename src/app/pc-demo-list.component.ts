...
import {routerConfig as timeSelectionConfig} from "./demo/pc/time-selection/demo-set.module";
...
export class DemoListManager {
    ...
    private static _mergeRoutes(routerConfig: any[]) {
        ...
        this._addRouterConfig(routerConfig, 'time-selection', timeSelectionConfig);
    }
