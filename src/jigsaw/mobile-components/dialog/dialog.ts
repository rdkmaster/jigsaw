...
export interface IDialog extends IPopupable {
    buttons: ButtonInfo[];
    caption: string;
    dialog: JigsawMobileDialog;
    dispose: (answer?: ButtonInfo) => void;
}

export type DialogMobileCallback = (button: ButtonInfo) => void;
 ...
 */
export abstract class AbstractMobileDialogComponentBase
...
@Component({
    selector: 'jigsaw-mobile-dialog, jm-dialog',
    templateUrl: 'dialog.html',
})
export class JigsawMobileDialog extends AbstractMobileDialogComponentBase {
    @Output()
