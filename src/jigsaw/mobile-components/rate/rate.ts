...
@Component({
    selector: 'jigsaw-mobile-rate, jm-rate',
    ...
    providers: [
        {
            ...
            useExisting: forwardRef(() => JigsawMobileRateComponent),
            multi: true
        }
    ],
})
export class JigsawMobileRateComponent extends AbstractJigsawComponent implements OnInit, ControlValueAccessor {
    /**
     * @internal
     */
