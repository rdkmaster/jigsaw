 ...
 */
@Component({
    selector: 'jigsaw-mobile-slider-handle',
    templateUrl: './slider-handle.html',
    encapsulation: ViewEncapsulation.None
})
export class JigsawMobileSliderHandle implements OnInit {
 ...
 */
@Component({
    selector: 'jigsaw-mobile-slider, jm-slider',
    ...
    encapsulation: ViewEncapsulation.None,
    providers: [
        {provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => JigsawMobileSlider), multi: true},
    ]
})
export class JigsawMobileSlider extends AbstractJigsawComponent implements ControlValueAccessor, OnInit, OnDestroy {
    ...
    // Todo 支持滑动条点击.
    @ViewChildren(JigsawMobileSliderHandle) private _sliderHandle: QueryList<JigsawMobileSliderHandle>;
