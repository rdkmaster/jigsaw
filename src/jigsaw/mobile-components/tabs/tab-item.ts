 ...
 */
@Component({
    selector: 'jigsaw-mobile-tab-label',
    template: `
        <ng-template #body></ng-template>
        <span class="jigsaw-tabs-remove-bar" *ngIf="editable" (click)="_$handleRemove($event)">&times;</span>
    `
})
export class JigsawMobileTabLabel extends JigsawMobileTabBase implements AfterViewInit {
 ...
 */
@Component({
    selector: 'jigsaw-mobile-tab-content',
    host: {
...
export class JigsawMobileTabContent extends JigsawMobileTabBase implements AfterViewInit {
