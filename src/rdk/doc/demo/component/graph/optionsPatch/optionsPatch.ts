...
@Component({
    templateUrl: 'optionsPatch.html'
})

export class GraphOptionsPatchComponent implements OnInit {
    ...
    click(){
        this.data.optionsPatch= {title:{text : "New Text"}};
    }
}
            ...
            series: [
                {
                    ...
                    stack: '总量',
                    areaStyle: {normal: {}},
                    data: ["120", "132", "101", "134", "90", "230", "210"].map(function (str) {
                        return str.replace(' ', '\n')
                    })
                },
                {
